...
///passport
const { initPassportMid, initPassportGitHub } = require('./passport/strategies')
...
app.use(session({
    store: create({
        mongoUrl: 'mongodb+srv://andrescoria1984:Martin17b@comision39750.v1faao5.mongodb.net/Ecommerce?retryWrites=true&w=majority',
        mongoOptions: {
